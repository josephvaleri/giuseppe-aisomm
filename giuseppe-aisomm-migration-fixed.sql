-- =====================================================
-- Giuseppe the AISomm - Complete Database Migration (FIXED)
-- =====================================================
...
-- Moderation workflow (FIXED: removed IF NOT EXISTS from CREATE TYPE)
do $$ begin
    create type moderation_status as enum ('pending','accepted','rejected','edited');
exception
