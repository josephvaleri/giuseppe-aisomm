 ...
 */
export async function searchAppellationsByCountryRegion(countryName: string, regionName: string): Promise<{appellations: AppellationResult[], usedFallback: boolean}> { call the Open
  const supabase = createServiceClient()
